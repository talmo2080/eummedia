  ...
  return (
    <button
      ...
      style={{
        ...
        background: bg || (h ? "#f0f4f8" : "#fff"),
        border: "1px solid " + (h ? "#0d2d52" : "#e0e0e0"),
        boxShadow: h ? "0 4px 12px rgba(0,0,0,0.15)" : "0 2px 8px rgba(0,0,0,0.08)",
        display: "flex", flexDirection: "column", alignItems: "center",
        justifyContent: "center", cursor: "pointer", transition: "all 0.2s",
        gap: "1px", color: fg || (h ? "#0d2d52" : "#555"),
      }}
    >
      {children}
    </button>
  ...
  return (
    <button
      ...
      style={{
        ...
        background: h ? "#0d2d52" : "#fff",
        border: "2px solid " + (h ? "#0d2d52" : "#ddd"),
        color: h ? "#fff" : "#0d2d52",
