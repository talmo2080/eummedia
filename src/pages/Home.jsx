        ...
        <div className="px-4 mb-7">
          <div style={{ background:"#f0fdf4", border:"2px solid #166534", padding:"16px" }}>
            ...
            <div style={{ display:"flex", flexDirection:"column", alignItems:"center", textAlign:"center", gap:"8px", marginBottom:"14px" }}>
              ...
              <div style={{ fontSize:"15px", fontWeight:"800", color:"#166534", lineHeight:"1.4" }}>
                경험이 기술을 입다
              </div>
              <div style={{ fontSize:"12px", color:"#3d3d3d", lineHeight:"1.6" }}>
                비개발자가 만든 웹앱이 피어나는 곳
              </div>
            </div>
            <Link to="/pium"
                  style={{ display:"block", textAlign:"center", background:"#166534", color:"white", padding:"10px", fontSize:"14px", fontWeight:"700", textDecoration:"none", fontFamily:"'Noto Sans KR', sans-serif", borderRadius:"2px", marginBottom:"8px" }}>
              웹앱스토어 구경하기 →
            </Link>
            <Link to="/pium-request"
                  style={{ display:"block", textAlign:"center", background:"transparent", color:"#166534", padding:"9px", fontSize:"14px", fontWeight:"700", textDecoration:"none", fontFamily:"'Noto Sans KR', sans-serif", borderRadius:"2px", border:"1.5px solid #166534" }}>
              이런 앱이 필요하세요? →
            </Link>
          </div>
        </div>
      ...
      <div className="hidden lg:grid lg:grid-cols-[1fr_300px]" style={{ maxWidth:"1200px", margin:"0 auto", padding:"32px 32px 56px", gap:"40px", alignItems:"start" }}>
        ...
        <aside className="lg:sticky lg:top-5" style={{ display:"flex", flexDirection:"column", gap:"24px" }}>
          ...
          <div style={{ background:"#f0fdf4", border:"2px solid #166534", padding:"16px" }}>
            ...
            <Link to="/pium"
                  style={{ display:"block", textAlign:"center", background:"#166534", color:"white", padding:"9px", fontSize:"11px", fontWeight:"700", textDecoration:"none", fontFamily:"'Noto Sans KR', sans-serif", borderRadius:"2px", marginBottom:"8px" }}>
              웹앱스토어 구경하기 →
            </Link>
            <Link to="/pium-request"
